...
class LoginController extends Controller
{
    ...
    {
        $account = User::firstOrNew(['cid' => $resourceOwner->data->cid]);
        if ($resourceOwner->data->oauth->token_valid === "true") { // User has given us permanent access to data     
            ...
            $account->cid=$resourceOwner->data->cid;
            $account->last_name=$resourceOwner->data->personal->name_last;
            $account->rating=$resourceOwner->data->vatsim->rating->short;
            $account->pilot_rating=$resourceOwner->data->vatsim->pilotrating->short;
            $account->division=$resourceOwner->data->vatsim->division->name;
            $account->region=$resourceOwner->data->vatsim->region->name;
            $account->division_code=$resourceOwner->data->vatsim->division->id;
            $account->subdivision=$resourceOwner->data->vatsim->subdivision->name;
        }
